...
#            'options' : ["-fullstimer", "-autoexec", f'{os.environ["WORKSPACE"]}/github/Workbench-repo/_setup/autoexec.sas']
#            }
#with open("/workspaces/mainstorage/github/Workbench-repo/_setup/autoexec.sas", 'r', encoding='utf-8') as file:
...
httpsviya = {'url'     : 'https://verde-viya.mtes-tt.unx.sas.com',
